...
<div class="book">
        ...
        <form class="form" action="apply" method="get">
            ...
            <select name="university" required>
                        ...
                        <option>DEF College</option>
                        <option>GHI College</option>
                        <option>JKL College</option>
                        <option>MNO College</option>
                    </select>
                    <select name="courses" required>
                        <option value="" disabled selected hidden>Select Course Category intrested in </option>
                        <option>Bachelors of Computer Application</option>
                        <option>Bachelors of Visual Arts</option>
