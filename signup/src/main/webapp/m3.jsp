        ...
        <div class="row">
            <div class="col-md-4">
                <div class="single-blog">
                    ...
                    <h2> XYZ PG</h2>
                    <p class="blog-text">Private Room<br> <i class="fa-solid fa-indian-rupee-sign"> 7,000 including all aminities</i></p> <br>
            ...
            <div class="col-md-4">
                <div class="single-blog1">
                    <img src="assets/img/portfolio/m3.jpeg" alt="pic1">
                    <h2> XYZ PG</h2>
                    <p class="blog-text1">Two People Sharing<br> <i class="fa-solid fa-indian-rupee-sign"> 6,000 including all aminities</i></p> <br>
            ...
            <div class="col-md-4">
                <div class="single-blog2">
                    <img src="assets/img/portfolio/m3.jpeg" alt="pic1">
                    <h2> XYZ PG</h2>
                    <p class="blog-text2">Three People Sharing<br> <i class="fa-solid fa-indian-rupee-sign"> 5,000 including all aminities</i></p> <br>
