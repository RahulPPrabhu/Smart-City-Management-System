    ...
    <div class="row">
        <div class="col-md-4">
            <div class="single-blog">
                ...
                <p class="dtime">23:40</p>
                <p class="hour">07h 50m</p>
                <p class="atime">07:30</p>
                <p class="dplace">Hebbal</p>
                <p class="aplace">Lakdikapul</p>
                <p><a href="seat3.jsp" class="read-more-btn">View Seats</a></p>
                <p class="rate">INR 1790</p>
        ...
        <div class="col-md-4">
            <div class="single-blog1">
                ...
                <p class="dtime1">22:45</p>
                <p class="hour1">08h 20m</p>
                <p class="atime1">07:05</p>
                <p class="dplace1">Anand Rao Circle</p>
                <p class="aplace1">Lakdikapul</p>
                <p><a href="seat4.jsp" class="read-more-btn1">View Seats</a></p>
                <p class="rate1">INR 2199</p>
        ...
        <div class="col-md-4">
            <div class="single-blog2">
                ...
                <p class="dtime2">22:30</p>
                <p class="hour2">08h 45m</p>
                <p class="atime2">07:15</p>
                <p class="dplace2">Anand Rao Circle</p>
                <p class="aplace2">Lakdikapul</p>
                <p><a href="seat5.jsp" class="read-more-btn2">View Seats</a></p>
                <p class="rate2">INR 2799</p>
