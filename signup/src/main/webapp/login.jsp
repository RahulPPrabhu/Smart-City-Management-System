...
<body>
    ...
    <section>
        <div class="imgBx">
            <img src="assets/img/portfolio/bg.jpg">
        </div>
        <div class="contentBx">
            <div class="formBx">
                <h2>Login</h2>
                <form action="login" method="post" autocomplete="off">
                    ...
                    <div class="inputBx">
                        <p>Don't have an account? <a href="registration.jsp"> Sign up </a></p> <br>
                        <p>Forgot Password <a href="forgotPassword.jsp">Reset</a></p> <br>
                        <p> Admin Login <a href="adminlogin.jsp">Click here</a></p>
                    </div>
                </form>
            </div>
        </div>
