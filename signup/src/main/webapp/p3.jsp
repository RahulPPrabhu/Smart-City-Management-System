        ...
        <div class="row">
            <div class="col-md-4">
                <div class="single-blog">
                    ...
                    <h2> XYZ PG</h2>
                    <p class="blog-text">Private Room<br> <i class="fa-solid fa-indian-rupee-sign"> 6,350 including all aminities</i></p> <br>
            ...
            <div class="col-md-4">
                <div class="single-blog1">
                    <img src="assets/img/portfolio/p5.png" alt="pic1">
                    <h2> XYZ PG</h2>
                    <p class="blog-text1">Two People Sharing<br> <i class="fa-solid fa-indian-rupee-sign"> 5,350 including all aminities</i></p> <br>
            ...
            <div class="col-md-4">
                <div class="single-blog2">
                    <img src="assets/img/portfolio/p5.png" alt="pic1">
                    <h2> XYZ PG</h2>
                    <p class="blog-text2">Three People Sharing<br> <i class="fa-solid fa-indian-rupee-sign"> 4,350 including all aminities</i></p> <br>
