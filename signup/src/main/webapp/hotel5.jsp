...
<div class="row">
        <div class="col-md-4">
            <div class="single-blog">
                <img src="assets/img/portfolio/dhotel1.jpg" alt="pic1">
                <h2> KKK Hotel</h2>
                ...
                <p class="location"><i class="fa-solid fa-location-dot"></i> <span>Delhi</span> </p> <hr class="info">
                ...
                <p class="rate"> <i class="fa-solid fa-indian-rupee-sign"></i> <span>7,250</span></p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="side-box">
        ...
        <div class="col-md-4">
            <div class="single-blog1">
                <img src="assets/img/portfolio/dhotel2.jpg" alt="pic1">
                <h2> LLL Hotel</h2>
                <p class="ratings1"><i class="fa-solid fa-star"></i>
                    <i class="fa-solid fa-star"></i>
                    <i class="fa-solid fa-star"></i> <span>Hotel</span></p> <hr class="second">
                <p class="location1"><i class="fa-solid fa-location-dot"></i> <span>Delhi</span> </p> <hr class="info1">
                ...
                <p class="rate1"> <i class="fa-solid fa-indian-rupee-sign"></i> <span>9,550</span></p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="side-box1">
        ...
        <div class="col-md-4">
            <div class="single-blog2">
                <img src="assets/img/portfolio/dhotel3.jpg" alt="pic1">
                <h2> MMM Hotel</h2>
                <p class="ratings2"><i class="fa-solid fa-star"></i>
                    <i class="fa-solid fa-star"></i> <span>Hotel</span></p> <hr class="third">
                <p class="location2"><i class="fa-solid fa-location-dot"></i> <span>Delhi</span> </p> <hr class="info2">
                ...
                <p class="rate2"> <i class="fa-solid fa-indian-rupee-sign"></i> <span>6,510</span></p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="side-box2">
