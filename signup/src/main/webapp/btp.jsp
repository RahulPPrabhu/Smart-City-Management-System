    ...
    <div class="row">
        <div class="col-md-4">
            <div class="single-blog">
                ...
                <p class="dtime">16:00</p>
                <p class="hour">14h 00m</p>
                <p class="atime">06:00</p>
                <p class="dplace">Anand Rao Circle</p>
                <p class="aplace">Wakad</p>
                <p><a href="seat6.jsp" class="read-more-btn">View Seats</a></p>
                <p class="rate">INR 3800</p>
        ...
        <div class="col-md-4">
            <div class="single-blog1">
                ...
                <p class="dtime1">18:30</p>
                <p class="hour1">14h 00m</p>
                <p class="atime1">08:30</p>
                <p class="dplace1">Anand Rao Circle</p>
                <p class="aplace1">Wakad</p>
                <p><a href="seat7.jsp" class="read-more-btn1">View Seats</a></p>
                <p class="rate1">INR 2800</p>
        ...
        <div class="col-md-4">
            <div class="single-blog2">
                ...
                <p class="dtime2">16:30</p>
                <p class="hour2">13h 30m</p>
                <p class="atime2">06:00</p>
                <p class="dplace2">Anand Rao Circle</p>
                <p class="aplace2">Katraj</p>
                <p><a href="seat8.jsp" class="read-more-btn2">View Seats</a></p>
                <p class="rate2">INR 2500</p>
