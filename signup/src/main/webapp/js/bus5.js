...
var booked4 = !!localStorage.getItem('booked4') ? $.parseJSON(localStorage.getItem('booked4')) : [];
$(document).ready(function() {
    ...
    sc.get(booked4).status('unavailable');
...
$(function() {
    $('#checkout-button').click(function() {
        ...
        if (Object.keys(booked4).length > 0) {
            Object.keys(booked4).map(k => {
                selected.push(booked4[k])
            })
        }
        localStorage.setItem('booked4', JSON.stringify(selected))
