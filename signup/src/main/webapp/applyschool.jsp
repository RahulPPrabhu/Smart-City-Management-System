...
<div class="book">
        ...
        <form class="form" action="school" method="get">
            ...
            <select name="university" required id="slct1">
                    	<option value="" disabled selected hidden>Select School </option>
                    	<option value="CBSE">ABC School</option>
                        <option value="ICSE">DEF School</option>
                        <option value="State">GHI School</option>
                        <option value="State">JKL School</option>
                        <option value="CBSE">MNO School</option>
                    </select>
             <input type="text" placeholder="Board" name ="courses" id="ticket" readonly> 
...
slct1.addEventListener("change",changeTextBoxText);
