 ...
 <div class="row">
        <div class="col-md-4">
           <div class="single-blog">
               ...
               <p id="degree">Board: CBSE [Central Board of Secondary Education]</p>
               ...
               <button type="submit"><a href="applyschool.jsp">Apply Now</a></button>

            </div>
        </div>
        <div class="col-md-4">
            <div class="single-blog1">
                 <h2> DEF School-Bangalore</h2>
                ...
                <p id="degree1">Board: ICSE [Indian Certificate of Secondary Education]</p>
                ...
                <button type="submit" id="second"><a href="applyschool.jsp">Apply Now</a></button>
 
             </div>
         </div>
         <div class="col-md-4">
            <div class="single-blog2">
                 <h2> GHI School-Bangalore</h2>
                ...
                <p id="degree2">Board: State Board</p>
                ...
                <button type="submit" id="second1"><a href="applyboard.jsp">Apply Now</a></button>
 
             </div>
         </div>
         <div class="col-md-4">
            <div class="single-blog3">
                 <h2> JKL School-Bangalore</h2>
                ...
                <p id="degree3">Board: State Board</p>
                ...
                <button type="submit" id="second2"><a href="applyschool.jsp">Apply Now</a></button>
 
             </div>
         </div>
         <div class="col-md-4">
            <div class="single-blog4">
                 <h2> MNO School-Bangalore</h2>
                ...
                <p id="degree4">Board: CBSE[Central Board of Secondary Education]</p>
                ...
                <button type="submit" id="second3"><a href="applyschool.jsp">Apply Now</a></button>
