        ...
        <div class="row">
            <div class="col-md-4">
                <div class="single-blog">
                    ...
                    <h2> GHI PG</h2>
                    <p class="blog-text">Private Room<br> <i class="fa-solid fa-indian-rupee-sign"> 10,000 including all aminities</i></p> <br>
            ...
            <div class="col-md-4">
                <div class="single-blog1">
                    <img src="assets/img/portfolio/h4.jpg" alt="pic1">
                    <h2> GHI PG</h2>
                    <p class="blog-text1">Two People Sharing<br> <i class="fa-solid fa-indian-rupee-sign"> 9,000 including all aminities</i></p> <br>
            ...
            <div class="col-md-4">
                <div class="single-blog2">
                    <img src="assets/img/portfolio/h4.jpg" alt="pic1">
                    <h2> GHI PG</h2>
                    <p class="blog-text2">Three People Sharing<br> <i class="fa-solid fa-indian-rupee-sign"> 8,000 including all aminities</i></p> <br>
