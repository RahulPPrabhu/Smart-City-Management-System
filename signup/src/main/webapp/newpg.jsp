...
<%
try{
	String Query = "select city,pgname,price,area from adminpg where id="+request.getParameter("cmb");
	Class.forName("com.mysql.jdbc.Driver").newInstance();
	...
	while(resultset.next()){
		...
		<td><input type="text" class="text" value="<%=resultset.getString("pgname")%>" readonly></td>
...
<button type="button"><a href="adminpgbooking.jsp">Book Now</a></button>
</body>
</html>