 ...
 */
@WebServlet("/hmail")
public class Hmail extends HttpServlet {
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if(email!=null || !email.equals("")) {
				...
				try {
					...
					message.setText("Thank You For Booking: "+ mess+" Arrival Date: " +date+" Date Of Checkout "+datec+" Room Type Selected: "+adult+" Book-in City: "+child+" price : "+price);
					// send message
				...
				dispatcher = request.getRequestDispatcher("hmail.jsp");
